...
//    qRegisterMetaType<QQMLChartList>("QQMLChartList");
    ...
    ColorsChart* clr1 = new ColorsChart("darkred");                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ColorsChart("#F38630");
    ColorsChart* clr2 = new ColorsChart("rgba(220,220,220,0.5)");
    ColorsChart* clr3 = new ColorsChart("rgba(151,187,205,0.5)");
    VectorRound* vr1  = new VectorRound();

    vr1->addValue(15 , "Inicio",clr1);
    vr1->addValue(50 , "Meio"  ,clr2);
    vr1->addValue(100 , "Meiuca",clr3);
...
//    chart->addCustomDataset(cd);
    qDebug() << chart->toJson();
    chart->jsonToObject<BarChart>(chart->toJson());

    engine.rootContext()->setContextProperty("chartDATA",dynamic_cast<QMLChart*>(chart));
